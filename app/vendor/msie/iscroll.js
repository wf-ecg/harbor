// MOD by drt for GetCollegeReady
...
var IScroll = (function (window, document, Math) {
    ...
    var utils = (function () {
        ...
        me.addEvent = function (el, evt, fn, bubble) {
        ...
        me.removeEvent = function (el, evt, fn, bubble) {
    ...
    IScroll.prototype = {
        ...
        _translate: function (x, y) {
            ...
            /* REPLACE END: _translate */
                ...
                x = Math.round(x);
                y = Math.round(y);
                try { // IE8 has no accessors for this non-element
